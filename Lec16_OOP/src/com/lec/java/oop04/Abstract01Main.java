...
public class Abstract01Main {
	...
	public static void main(String[] args) {
		...
		// 추상클래스는 인스턴스 생성 불가능
		// TestAbstract test1 = new TestAbstract(); // 에러: Cannot instantiate the type
		// TestAbstract
...
class TestClass extends TestAbstract { // The type TestClass must implement the inherited abstract method
										// TestAbstract.testMethod()
