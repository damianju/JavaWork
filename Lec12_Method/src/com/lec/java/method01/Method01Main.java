...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("안녕하세요.");
		System.out.println("제 이름은 이걍혁입니다");
		...
		sayAge(16);
		sayAge(20);
		com.lec.java.method01.Method01Main.sayAge(14);
		...
		// sayHello2(100,200); //The method sayHello2(String, int) in the type
