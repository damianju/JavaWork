...
public class Inherit03Main {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println(p2); //com.lec.java.inherit03.BusinessPerson@15db9742
		// 내부적으로는 p2.toString()의 결과값이 출력
		System.out.println(p2.toString()); //com.lec.java.inherit03.BusinessPerson@15db9742
		// toString()은 Object 소속 메소드
