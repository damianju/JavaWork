...
public class RegExp03Main {
	...
	public static void main(String[] args) {
		...
		regex = "^[a-z]{2,}+\\W$"; // The 로 시작하는 문자열 패턴
		arrInput = new String[] {
				"the",
				"the,", // X
				" the the the", // X
				"the! the the the" // 1개 매칭
		};
...
/*		title = "$ : 문자열의 마지막이 이 문자열로 마무리 됨";
		...
		arrInput = new String[] {
				...
				"xbz",				
				"xyyz x1y xyyyy xxxxyyyyxxxyyyxyxyxyxy"
		};
		...
		regex = "ab{2}"; // a로 반드시 시작, b가 2개에 매칭
		arrInput = new String[] {
				"abb",
				"abbb",
