...
public class Exception05Main {
	...
	public static void main(String[] args) {
		...
		} catch (ArithmeticException | NullPointerException | ArrayIndexOutOfBoundsException ex) { //The exception ArithmeticException is already caught by the alternative Exception
