...
// getter 함수는 아래와 같이 '조회'하려할 때 함수가 호출 됩니다.
//console.log(numbers.sum()) // numbers.sum is not a function 에러
...
// 함수 구성에 따른 성능 차이를 보여주는 사례 (set 할 때만 연산 발생)
console.log();
console.log(numbers3.sum);
numbers3.a = 10; // setter 동작, +연산 발생
numbers3.b = 20;
console.log(numbers3.sum); // 여러 번 조회해도 이미 연산되 결과값만 보여줌. 재계산 안함.
console.log(numbers3.sum);
console.log(numbers3.sum);
console.log(numbers3.sum);
console.log(numbers3.sum);
