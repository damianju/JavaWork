...
public class DateTime01Main {
	...
	public static void main(String[] args) throws Exception{
		...
		SimpleDateFormat fmt = new SimpleDateFormat("yyyy년 MM월 dd일 hh시 mm분 ss초"); //hh 12시간제
